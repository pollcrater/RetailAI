...
def prompt_db_summary(*, metrics: dict[str, Any]) -> str:
    return (
        ...
        "Write a concise business summary from the provided metrics JSON. "
        "Highlight KPIs, trends, and period-over-period changes when available. "
        "If KPI fields are missing, summarize schema, sample rows, and numeric profiles instead. "
